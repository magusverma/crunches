...
class ThemesControllerTest < ActionController::TestCase
  ...
  test "should create theme" do
    assert_difference('Theme.count') do
      post :create, theme: { database_url: @theme.database_url, details: @theme.details, name: @theme.name }
    end
  ...
  test "should update theme" do
    patch :update, id: @theme, theme: { database_url: @theme.database_url, details: @theme.details, name: @theme.name }
    assert_redirected_to theme_path(assigns(:theme))
  end
